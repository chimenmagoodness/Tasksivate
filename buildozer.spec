...
package.domain = org.tasksivating

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (let empty to include all the files)
source.include_exts = py,png,jpg,kv,atlas,ttf,otf,fontd,ico,json,txt,csv, jfif,jpeg
...
requirements = python3,kivy,sdl2_ttf==2.0.15,docutils,certifi,jnius,pillow,kivymd,requests,plyer,pyjnius,matplotlib,https://github.com/MichaelStott/KivMob/archive/refs/heads/master.zip
...
icon.filename = %(source.dir)s/store/icon_image.png
...
services = Tasksivate:service.py #NAME:ENTRYPOINT_TO_PY,NAME2:ENTRYPOINT2_TO_PY
